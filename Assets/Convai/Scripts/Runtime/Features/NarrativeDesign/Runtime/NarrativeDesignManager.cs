...
namespace Convai.Scripts.Runtime.Features
{
    ...
    public class NarrativeDesignManager : MonoBehaviour
    {
        ...
        public void BTResponse(string narrativeSectionId)
        {
            Debug.Log("[WebGL] BTResponse recibido: " + narrativeSectionId);
        ...
        {
            Debug.Log($"[UpdateCurrentSection] incoming sectionID={sectionID}, current={_currentSectionID}");
        ...
        {
            Debug.Log($"[InvokeSectionEvent] Checking sectionId={id}, isStarting= {isStarting}");
