...
namespace Convai.Scripts.Runtime.UI
{
    ...
    public class UISettingsPanel : MonoBehaviour
    {
        ...
        public CanvasGroup PanelCanvasGroup { get => _panelCanvasGroup; set => _panelCanvasGroup = value; }
        ...
        {
            _fadeCanvas.StartFadeIn(PanelCanvasGroup, _fadeInDuration);
        }
        ...
        {
            _fadeCanvas.StartFadeOut(PanelCanvasGroup, _fadeOutDuration);
        }
        ...
        {
            _fadeCanvas.StartFadeOutFadeInWithGap(PanelCanvasGroup, fadeInDuration, fadeOutDuration, previewDuration);
        }
