...
        public void SetInteractionTarget(ConvaiNPC targetNPC)
        {
...
        /// </summary>
        public void InterruptCharacterSpeechInternal()
        {
...
        private string GetJsonString(object obj, string context)
    ...
    // Asegúrate de que estas funciones existen en tu archivo .jslib
